...
public abstract class Modifier extends Reaction {
    Modifier(Pokemon user, Object source, float modifier, BiFunction<SingleField, Action, Boolean> check, Predicate<SingleField> action) {
        super(user, source, Message.NONE, check, action);
